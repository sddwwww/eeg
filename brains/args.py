...
import pickle
import json
# from brains.datautils import load_EEG,load_EEG_with_img_name
...
# if args2.data_path is None:
#     if args2.dataset == 'eeg':
...
#         args2.num_class = len(set(Train_data[1]))
# else:
#     if args2.dataset == 'eeg':
#         path = args2.data_path
#         Train_data_all, Train_data, Test_data = load_EEG()
#         ## Load from file
#         # with open("data/EEG_divided/Train_data_all_subj2.pkl", "rb") as f:
#         #     Train_data_all = pickle.load(f)
...
#         args2.num_class = len(set(Train_data[1]))
#
# args2.eval_per_steps = max(1, int(len(Train_data[0]) / args2.train_batch_size))
# args2.lr_decay_steps = args2.eval_per_steps
# if not os.path.exists(args2.save_path):
#     os.makedirs(args2.save_path)
# config_file = open(args2.save_path + '/args.json', 'w')