...
for name, prompt in prompts:
    ...
    # first stage
    os.system(f'python main.py --config configs/text.yaml prompt="{prompt}" save_path={name}')
    # second stage
    os.system(f'python main2.py --config configs/text.yaml prompt="{prompt}" save_path={name}')
