...
class GUI:
    def __init__(self, opt):
        ...
        # input eeg
        self.eeg_input = None  # EEG 信号输入
        self.negative_eeg = None  # 负样本 EEG 信号
        self.subject = 4
        self.eeg_dataset = None
        self.eeg_splitter = None
        self.crop_ratio = 0.2
        self.img_size = 512
        self.eeg_index = 0
    ...
    def prepare_train(self):
        ...
        self.enable_sd = self.opt.lambda_sd > 0 and self.eeg_input is not None
        ...
        with torch.no_grad():
            ...
            if self.enable_sd:
                if self.opt.imagedream:
                    ...
                    self.guidance_sd.get_eeg_embeds(self.eeg_input)
    ...
    def load_egg_input(self):
        ...
        specific_input, gt_image, img_name, prompt = test_dataset[idx_to_test]
        self.eeg_input = specific_input.unsqueeze(0).float()  # (1,440,128)
        print("----EEG input shape----: ", self.eeg_input.shape)
